      ...
      >
        <div className="flex flex-col gap-16">
          <p className="mb-8 text-15 text-typography-secondary">
            <Trans>
              HFDX Solana is hosted on another website and run by a different team, so the experience may vary slightly.
              <br />
              <br />
              Clicking on the button below will open the HFDX Solana frontend in a new tab.
            </Trans>
          </p>

          <ExternalLink href="https://gmxsol.io/trade" className="!no-underline">
            <Button variant="primary-action" className="w-full">
              <Trans>Open HFDX Solana</Trans>
            </Button>
          </ExternalLink>
        </div>
      </Modal>
