...
function SEO(props) {
  ...
  const meta = {
    title: t`HFDX | Decentralized Perpetual Exchange`,
    ...
    image: "https://app.hfdx.xyz/og.png",
    type: "exchange",
    ...customMeta,
  };
  return (
    <>
      <Helmet>
        ...
        <meta property="og:site_name" content="HFDX" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@hfdx_xyz" />
