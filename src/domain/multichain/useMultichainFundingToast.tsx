  ...
  useEffect(() => {
    ...
    let content: ToastContent = (
      <div className="flex flex-col gap-8">
        {hasDeposits && !hasWithdrawals && <Trans>Depositing funds to HFDX Account</Trans>}
        {hasWithdrawals && !hasDeposits && <Trans>Withdrawing funds from HFDX Account</Trans>}
        {hasDeposits && hasWithdrawals && <Trans>Depositing and withdrawing funds to/from HFDX Account</Trans>}
